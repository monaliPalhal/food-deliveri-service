  ...
  <form action="" name="signup" method="post" align = "center" onsubmit="return checkpass();">
    ...
    <div class="container" align="center">
        <input class="form-control" placeholder="FirstName" type="text" value="" id="firstname" name="firstname" required="true">
          ...
          <input type="password" class="form-control" id="repeatpassword" value="" placeholder = "Repeate password" name="repeatpassword" required="true" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required> 
